...
import 'package:appflowy_editor/src/render/rich_text/rich_text_span.dart';
...
class AppFlowyEditor extends StatefulWidget {
  ...
  final TextSpanBuilder? customTextSpanBuilder;
...
class _AppFlowyEditorState extends State<AppFlowyEditor> {
  ...
  AppFlowyRenderPlugin _createRenderPlugin() => AppFlowyRenderPlugin(
        ...
        textSpanBuilder: widget.customTextSpanBuilder ?? RichTextSpanBuilder(),
